...
<div class="w-full flex justify-between items-center mb-4">
         <h2 class="text-white font-semibold text-2xl">Admin / Manage Admissions</h2>
      </div>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
      ...
      ?>
       <tr>
        ...
        <a href="?approve=<?= $value['roll'];?>" class=" p-2 bg-red-500 text-white rounded">Approve</a>
        <a href="" class=" p-2 bg-yellow-500 text-white rounded">Delete</a>
